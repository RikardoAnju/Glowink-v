...
@section('content')
       ...
       <section class="hero-wrap text-center relative">
        <div id="owl-hero" class="owl-carousel owl-theme light-arrows slider-animated">
          <div class="hero-slide overlay" style="background-image:url(images/banner6.png)">
            <div class="container">
              <div class="hero-holder">
                <div class="hero-message">
                  <h1 class="hero-title nocaps">GLowink 2024</h1>
          ...
          <div class="hero-slide overlay" style="background-image:url(images/banner1.jpg)">
            <div class="container">
              <div class="hero-holder">
                <div class="hero-message">
                  <h1 class="hero-title nocaps">Exclusive Products</h1>
                  <h2 class="hero-subtitle lines">Get awesome items only in Glowin online shop</h2>
                  <div class="buttons-holder">
          ...
          <div class="hero-slide overlay" style="background-image:url(images/banner4.jpg)">
            <div class="container">
              <div class="hero-holder">
                <div class="hero-message">
