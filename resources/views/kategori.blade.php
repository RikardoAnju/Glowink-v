...
<html lang="en">
  ...
  <body>
    ...
    <div class="max-w-6xl mx-auto">
      {{-- CLASS PRODUCT --}}
      <h1 class="text-4xl font-bold tracking-tight text-gray-900 uppercase text-center italic">face wash
      </h1>
      <br>
              ...
              <div class="mt-4 flex justify-between">
                <div> 
                  <h3 class="text-xs text-gray-700">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Face Wash
                    </p>
                    <p class="text-xs font-medium text-gray-900">Rp 55.000
                    </p>
                  </h3>
                </div>
              </div>
